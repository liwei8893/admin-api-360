...
class OrderDto implements MineModelExcel
{
    ...
    #[ExcelProperty(value: '平台编号', index: 5, customField: 'users.old_platform')]
    public string $users_old_platform;

    #[ExcelProperty(value: '有效期(天)', index: 6)]
    public string $indate;

    #[ExcelProperty(value: '实际付款金额', index: 7)]
    ...
    #[ExcelProperty(value: '微信编号', index: 10)]
    public string $payment_number;

    #[ExcelProperty(value: '支付类型', index: 11)]
    public string $pay_type;

    #[ExcelProperty(value: '支付终端', index: 12)]
    public string $tag_type;

    #[ExcelProperty(value: '状态', index: 13)]
    public string $status;

    #[ExcelProperty(value: '购买年级', index: 14)]
    public string $order_grade;

    #[ExcelProperty(value: '购买科目', index: 15)]
