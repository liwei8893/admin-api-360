...
class OrderSummaryDto implements MineModelExcel
{
    ...
    #[ExcelProperty(value: '核单类型', index: 4)]
    public string $type;

    #[ExcelProperty(value: '用户等级', index: 5)]
    public string $level;

    #[ExcelProperty(value: '是否添加微信', index: 6)]
    public string $has_wechat;

    #[ExcelProperty(value: '是否接通电话', index: 7)]
    ...
    #[ExcelProperty(value: '核单人ID', index: 10)]
    public string $created_id;

    #[ExcelProperty(value: '核单人', index: 11, customField: 'admin_user.nickname')]
