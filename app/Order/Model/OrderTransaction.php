...
class OrderTransaction extends MineModel
{
     ...
     * @var array
     */
    protected $casts = ['id' => 'integer', 'type_id' => 'integer', 'order_id' => 'integer', 'user_id' => 'integer', 'money' => 'decimal:2', 'new_user_id' => 'integer', 'new_shop_id' => 'integer', 'operator_id' => 'integer', 'object_id' => 'integer', 'headmaster_id' => 'integer'];
}