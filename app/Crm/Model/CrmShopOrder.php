...
class CrmShopOrder extends MineModel
{
     ...
     */
    protected array $casts = ['id' => 'integer', 'user_id' => 'integer', 'shop_id' => 'integer', 'amount' => 'decimal:2', 'order_status' => 'integer', 'task_type' => 'integer', 'address_id' => 'integer', 'course' => 'array', 'created_by' => 'integer', 'created_at' => 'datetime', 'updated_at' => 'datetime'];
