 ...
 * @property int $order_type 订单类型，1 - 虚拟订单，2 - 实体订单
 ...
 * @property int $created_id 创建人 ID，关联用户表
...
class CrmShopOrder extends MineModel
{
     ...
     */
    protected array $fillable = ['id', 'user_id', 'shop_id', 'order_number', 'amount', 'order_status', 'order_type', 'address_id', 'logistics_company', 'tracking_number', 'order_note', 'created_id', 'created_at', 'updated_at', 'deleted_at'];

    /**
     * The attributes that should be cast to native types.
     */
    protected array $casts = ['id' => 'integer', 'user_id' => 'integer', 'shop_id' => 'integer', 'amount' => 'decimal:2', 'order_status' => 'integer', 'order_type' => 'integer', 'address_id' => 'integer', 'created_id' => 'integer', 'created_at' => 'datetime', 'updated_at' => 'datetime'];
}
