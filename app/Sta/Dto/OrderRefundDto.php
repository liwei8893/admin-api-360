...
#[ExcelData]
class OrderRefundDto implements MineModelExcel
{
    ...
    #[ExcelProperty(value: '截止时间', index: 5, customField: 'order.course_end_time')]
    public string $course_end_time;

    #[ExcelProperty(value: '退费时间', index: 6)]
    public string $create_at;

    #[ExcelProperty(value: '时长(天)', index: 7, customField: 'order.indate')]
    public string $indate;

    #[ExcelProperty(value: '付款金额', index: 8, customField: 'order.actual_price')]
    public string $actual_price;

    #[ExcelProperty(value: '退费金额', index: 9)]
    public string $money;

    #[ExcelProperty(value: '实际报名年数', index: 10, customField: 'order.real_year')]
