 ...
 * @property string $value_type 键值数据类型：string,int,uint,bool,datetime,date
...
class SystemDictData extends MineModel
{
     ...
     */
    protected array $fillable = ['id', 'type_id', 'label', 'value', 'value_type', 'code', 'sort', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at', 'deleted_at', 'remark'];
