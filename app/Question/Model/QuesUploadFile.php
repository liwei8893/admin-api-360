...
class QuesUploadFile extends MineModel
{
     ...
     */
    protected ?string $table = 'ques_upload_file';

    /**
     * The attributes that are mass assignable.
     */
    protected array $fillable = ['id', 'ques_id', 'file_name', 'file_path', 'file_type', 'file_size', 'created_id', 'created_at', 'updated_id', 'updated_at'];

    /**
     * The attributes that should be cast to native types.
     */
    protected array $casts = ['id' => 'integer', 'ques_id' => 'integer', 'file_size' => 'decimal:2', 'created_id' => 'integer', 'created_at' => 'datetime', 'updated_id' => 'integer', 'updated_at' => 'datetime'];
}
