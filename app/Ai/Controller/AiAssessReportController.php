...
class AiAssessReportController extends MineController
{
     ...
     */
    #[GetMapping("index"), Permission("ai:assessReport, ai:assessReport:index")]
     ...
     * @throws \Psr\Container\NotFoundExceptionInterface
     */
    #[GetMapping("read/{id}"), Permission("ai:assessReport:read")]
    ...
    {
        return $this->service->import(\App\Ai\Dto\AiAssessReportDto::class) ? $this->success() : $this->error();
    }
    ...
    {
        return (new \Mine\MineCollection)->export(\App\Ai\Dto\AiAssessReportDto::class, '模板下载', []);
    }
    ...
    {
        return $this->service->export($this->request->all(), \App\Ai\Dto\AiAssessReportDto::class, '导出数据列表');
    }
